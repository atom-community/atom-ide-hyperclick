const config = {
  darwinTriggerKeys: {
    ...
    description:
      "macOS: Combination of keys to activate Hyperclick while hovering for text",
    type: "string",
    default: "metaKey",
    enum: [
      {
  ...
  linuxTriggerKeys: {
    ...
    description:
      "Linux: Combination of keys to activate Hyperclick while hovering for text",
    type: "string",
    default: "ctrlKey",
    enum: [
      {
  ...
  win32TriggerKeys: {
    ...
    description:
      "Windows: Combination of keys to activate Hyperclick while hovering for text",
    type: "string",
    default: "ctrlKey",
    enum: [
      {
