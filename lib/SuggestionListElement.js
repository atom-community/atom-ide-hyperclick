...
const scrollIntoView = require("./common/scrollIntoView");
...
class SuggestionList extends React.Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    if (!(suggestion != null && Array.isArray(suggestion.callback))) {
      throw new Error(
        'Invariant violation: "suggestion != null && Array.isArray(suggestion.callback)"'
      );
    }
  ...
  render() {
    ...
    return React.createElement(
      ...
      {
        className:
          "popover-list select-list hyperclick-suggestion-list-scroller",
        ref: (el) => {
          this._scroller = el;
        },
      },
  ...
  _updateScrollPosition() {
    ...
    scrollIntoView.scrollIntoViewIfNeeded(selectedNode, false);
  }
}

customElements.define(
  "atom-ide-hyperclick-suggestion-list",
