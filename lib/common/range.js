...
module.exports = {
  wordAtPositionFromBuffer: wordAtPositionFromBuffer,
  matchRegexEndingAt: matchRegexEndingAt,
  isPositionInRange: isPositionInRange,
  wordAtPosition: wordAtPosition,
  trimRange: trimRange,
  getWordFromMouseEvent: getWordFromMouseEvent,
  getWordFromCursorOrSelection: getWordFromCursorOrSelection,
};
