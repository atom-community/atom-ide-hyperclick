...
describe("main.js", () => {
  ...
  it("should add provider for getSuggestionForWord", async () => {
    ...
    const getSuggestionForWord = jasmine.createSpy("getSuggestionForWord").and.callFake(
      (textEditor, text, range) => ({ range, callback })
    );
  ...
  it("should add legacy provider for getSuggestionForWord", async () => {
    ...
    spyOn(testPackage, "getLegacyProvider").and.returnValue({getSuggestionForWord});
    await atom.packages.activatePackage("atom-ide-hyperclick");
    await atom.packages.activatePackage(testPackagePath);
  ...
  it("should add provider for getSuggestion", async () => {
    ...
    const callback = jasmine.createSpy("callback");
    const getSuggestion = jasmine.createSpy("getSuggestion").and.callFake(
      () => ({ range, callback })
    );
